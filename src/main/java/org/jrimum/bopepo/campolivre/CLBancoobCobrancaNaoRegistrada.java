...
/**
 * <p>
 * O campo livre do bancoob deve seguir esta forma:
 * </p>
 * 
...
public class CLBancoobCobrancaNaoRegistrada extends AbstractCLBancoob{
	 ...
	 */
	protected static final Integer CONSTANT_VALUE = Integer.valueOf(2);
	 ...
	 */
	private static final Field<Integer> PARCELA_UNICA = new Field<Integer>(CONSTANT_PARCELA_VALUE, NUMERO_DA_PARCELA_LENGTH, Filler.ZERO_LEFT);
